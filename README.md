...
- **Machines** — centralized page to monitor the same service across multiple machines via DevTunnels
...
| `--name <name>` | Display name for this machine (default: tunnel ID if set, otherwise `local`) |
